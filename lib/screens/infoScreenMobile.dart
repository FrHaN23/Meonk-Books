...
class InfoScreenMobileState extends State<InfoScreenMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          global.isDarkModeEnabled ? Colors.white : Colors.amber[100],
      appBar: AppBar(
        elevation: 0,
        brightness:
      ...
      body: Container(
        color: global.isDarkModeEnabled ? Colors.black : Colors.amber[100],
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Container(
                        padding: EdgeInsets.only(top: _width > 1200 ? 100 : 55),
                        child: Center(
                            child: Hero(
